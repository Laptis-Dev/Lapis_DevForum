...
class SimpleEditor {
    ...
    bindToolbarEvents() {
        ...
        if (strikeBtn)
            strikeBtn.addEventListener('click', () => this.formatText('strikeThrough'));
        if (undoBtn)
        ...
        if (saveAsBtn)
            saveAsBtn.addEventListener('click', () => this.saveAsTextFile());
    }
    bindEditorEvents() {
        if (!this.editor)
            return;
    ...
    toggleBackground() {
        if (!this.editor || !this.background)
            return;
    ...
    updateCursorPosition() {
        ...
        if (selection && selection.rangeCount > 0 && cursorPositionElement) {
            ...
            const col = ((_b = (_a = lines[lines.length - 1]) === null || _a === void 0 ? void 0 : _a.length) !== null && _b !== void 0 ? _b : 0) + 1;
